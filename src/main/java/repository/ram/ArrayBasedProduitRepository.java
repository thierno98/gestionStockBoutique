...
public class ArrayBasedProduitRepository {
    ...
    public  static void ShowAllProduit(List<Produit> _produits)
    {
    ...
    public static Produit SelectProduit(List<Produit> _produits)
    {
